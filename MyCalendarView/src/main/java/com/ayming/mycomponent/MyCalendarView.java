...
package com.ayming.mycomponent;
...
public class MyCalendarView extends FrameLayout {
     ...
     * Tag for logging.
     */
    private static final String LOG_TAG = MyCalendarView.class.getSimpleName();
    ...
    public interface OnDateChangeListener {
         ...
         */
        public void onSelectedDayChange(MyCalendarView view, int year, int month, int dayOfMonth);
    }
    ...
    public MyCalendarView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray attributesArray = context.obtainStyledAttributes(attrs, R.styleable.MyCalendarView,
                R.attr.calendarViewStyle, 0);
        mShowWeekNumber = attributesArray.getBoolean(R.styleable.MyCalendarView_showWeekNumber,
                DEFAULT_SHOW_WEEK_NUMBER);
        mFirstDayOfWeek = attributesArray.getInt(R.styleable.MyCalendarView_firstDayOfWeek,
                //LocaleData.get(Locale.getDefault()).firstDayOfWeek);
                Calendar.getInstance().getFirstDayOfWeek());
        String minDate = attributesArray.getString(R.styleable.MyCalendarView_minDate);
        if (TextUtils.isEmpty(minDate) || !parseDate(minDate, mMinDate)) {
            parseDate(DEFAULT_MIN_DATE, mMinDate);
        }
        String maxDate = attributesArray.getString(R.styleable.MyCalendarView_maxDate);
        ...
        mShownWeekCount = attributesArray.getInt(R.styleable.MyCalendarView_shownWeekCount,
                DEFAULT_SHOWN_WEEK_COUNT);
        mSelectedWeekBackgroundColor = attributesArray.getColor(
                R.styleable.MyCalendarView_selectedWeekBackgroundColor, 0);
        ...
        mWeekSeparatorLineColor = attributesArray.getColor(
                R.styleable.MyCalendarView_weekSeparatorLineColor, 0);
        mWeekNumberColor = attributesArray.getColor(R.styleable.MyCalendarView_weekNumberColor, 0);
        mSelectedDateVerticalBar = attributesArray.getDrawable(
                R.styleable.MyCalendarView_selectedDateVerticalBar);

        mDateTextAppearanceResId = attributesArray.getResourceId(
                R.styleable.MyCalendarView_dateTextAppearance, android.R.style.TextAppearance_Small);
        updateDateTextSize();

        mWeekDayTextAppearanceResId = attributesArray.getResourceId(
                R.styleable.MyCalendarView_weekDayTextAppearance,
                DEFAULT_WEEK_DAY_TEXT_APPEARANCE_RES_ID);

        final Drawable horizontalDivider = attributesArray.getDrawable(R.styleable.MyCalendarView_dividerHorizontal);
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(MyCalendarView.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(MyCalendarView.class.getName());
    }

    /**
     * Gets the minimal date supported by this {@link MyCalendarView} in milliseconds
    ...
    /**
     * Sets the minimal date supported by this {@link MyCalendarView} in milliseconds
     * since January 1, 1970 00:00:00 in {@link TimeZone#getDefault()} time
     * zone.
     *
    ...
    /**
     * Gets the maximal date supported by this {@link MyCalendarView} in milliseconds
     * since January 1, 1970 00:00:00 in {@link TimeZone#getDefault()} time
     * zone.
     * <p>
    ...
    /**
     * Sets the maximal date supported by this {@link MyCalendarView} in milliseconds
     * since January 1, 1970 00:00:00 in {@link TimeZone#getDefault()} time
     * zone.
     *
     ...
     *
     * @return The first day of the week conforming to the {@link MyCalendarView}
     *         APIs.
     * @see Calendar#MONDAY
            ...
            mAdapter.registerDataSetObserver(new DataSetObserver() {
                ...
                public void onChanged() {
                    if (mOnDateChangeListener != null) {
                        ...
                        mOnDateChangeListener.onSelectedDayChange(MyCalendarView.this,
    ...
    private void setUpListView() {
        ...
        mListView.setOnScrollListener(new OnScrollListener() {
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                MyCalendarView.this.onScrollStateChanged(view, scrollState);
            }

            public void onScroll(
                    AbsListView view, int firstVisibleItem, int visibleItemCount,
                    int totalItemCount) {
                MyCalendarView.this.onScroll(view, firstVisibleItem, visibleItemCount,
                        totalItemCount);
            }
        });
    ...
    private class WeekView extends View {
         ...
         *            {@link MyCalendarView#getMinDate()}.
